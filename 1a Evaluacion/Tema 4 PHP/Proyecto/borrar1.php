...
print "    <div style=\"text-align: center;\"><h3>Marque los registros que quiera borrar:</h3></div>\n";
?>
...
<div class="col-md-12" >
          <table class="table table-striped" style="width: 40%; margin: 0 auto; text-align: center">
            ...
            <tbody>
                ...
                foreach ($result as $valor) {
                    print "      <tr>\n";
                    print "        <td><input type=\"checkbox\" name=\"id[$valor[id]]\" /></td>\n";
        ...
        <div style="width: 100%; text-align: center; padding-top: 200px">
            ...
            <input type="submit" value="Borrar registro"  class="btn btn-primary" />
