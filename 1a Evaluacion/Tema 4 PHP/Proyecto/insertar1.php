...
<div class="input-group input-group-lg">
  ...
  <input type="text" name="correo" class="form-control" placeholder="Correo" aria-describedby="sizing-addon1">
</div>
<div class="input-group input-group-lg">
  <span class="input-group-addon btn" id="sizing-addon1">Direccion&nbsp;</span>
  <input type="text" name="direccion" class="form-control" placeholder="Direccion" aria-describedby="sizing-addon1">
</div>
